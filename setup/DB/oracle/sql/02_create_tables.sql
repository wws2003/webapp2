...
CREATE TABLE TBL_USER_PRIV(
	...
	privilege_id NUMBER(2,0) NOT NULL,
...
CREATE TABLE TBL_DOCUMENT_REFERENCE(
	id NUMBER(10,0) PRIMARY KEY NOT NULL,
	doc1_id NUMBER(10,0) NOT NULL,
	doc2_id NUMBER(10,0) NOT NULL,
...
CREATE TABLE TBL_POSTIT(
	...
	color NUMBER(3,0) NOT NULL,
	border_color NUMBER(3,0) NOT NULL,
	coord SDO_GEOMETRY NOT NULL,

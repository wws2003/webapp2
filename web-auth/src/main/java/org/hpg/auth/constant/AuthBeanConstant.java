...
public class AuthBeanConstant {
    ...
    public static class Qualifier {
        ...
        public static final String DEFAULT_SESSION_EXPIRED_STRATRGY_FOR_ADMINROLE = "sessionExpiredStrategyForAdminRole";
        public static final String DEFAULT_SESSION_EXPIRED_STRATRGY_FOR_USERROLE = "sessionExpiredStrategyForUserRole";

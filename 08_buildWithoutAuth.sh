...
# Package web-all
mvn clean package -ff -Dnoauth=true -Dnocomp=true -DskipTests=true -pl web-all -am
# Final package (to include web-common)
mvn war:war -ff -Dnoauth=true -Dnocomp=true -DskipTests=true -pl web-common,web-all 
